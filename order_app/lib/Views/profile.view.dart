...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget username = new TextField(
      ...
      style: _itemStyle,
      decoration:
          new InputDecoration(labelText: 'Username:', labelStyle: _itemStyle2),
    );
    ...
    Widget displayName = new TextField(
      ...
      decoration: new InputDecoration(
          labelText: 'Display name:', labelStyle: _itemStyle2),
    );
    ...
    Widget idCard = new TextField(
      ...
      style: _itemStyle,
      decoration:
          new InputDecoration(labelText: 'Id card:', labelStyle: _itemStyle2),
    );
    ...
    Widget address = new TextField(
      ...
      style: _itemStyle,
      decoration:
          new InputDecoration(labelText: 'Address:', labelStyle: _itemStyle2),
    );
    ...
    Widget phone = new TextField(
      ...
      style: _itemStyle,
      decoration:
          new InputDecoration(labelText: 'Phone:', labelStyle: _itemStyle2),
    );
    ...
    Widget oldPass = new TextField(
      ...
      style: _itemStyle,
      decoration: new InputDecoration(
          labelText: 'Old password:', labelStyle: _itemStyle2),
    );
    ...
    Widget newPass = new TextField(
      ...
      style: _itemStyle,
      decoration: new InputDecoration(
          labelText: 'New password:', labelStyle: _itemStyle2),
    );
                ...
                onPressed: () async {
                  ...
                  if (_newPassConfirmController.text ==
                    ...
                    if (await Controller.instance.updatePassword(
                      ...
                      login.Account account = widget.account;
                      account.password = Controller.instance
                          .toHashPass(_newPassController.text);
